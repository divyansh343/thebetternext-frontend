  ...
  const ptComponents = {
    ...
    marks: {
      ...
      link: ({ value, children }) => {
        ...
        return (
          <a href={value?.href} className="text-blue-500 underline" target={target} rel={target === '_blank' && 'noindex nofollow'}>
            {children}
          </a>
        )
      },
    ...
    <div>
      ...
      <div className="container mx-auto flex flex-wrap py-12">
        ...
        <aside className="w-full md:w-1/3 flex flex-col items-center px-3">
          ...
          {/* // for profile */}
          <div
            className="card  min-w-sm border border-gray-700 bg-white text-gray-50 my-4 transition-shadow shadow-xl hover:shadow-xl min-w-max mt-[40px] lg:mt-4">
